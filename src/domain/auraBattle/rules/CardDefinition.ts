...
export const CARDS:Record<CardId,CardDefinition>=Object.fromEntries([
 ...
 card({id:"no_reaction",name:"No Reaction",category:"DEADPAN",aura:2,hype:1,steal:1,counters:["CHAOS","MEME"],blurb:"Counter CHAOS. Steal 1 Aura.",script:"NO_REACTION"}),
 card({id:"check_phone",name:"Check Phone",category:"DEADPAN",aura:2,hype:1,counters:["CHAOS","COOL"],blurb:"Counter anything elaborate.",script:"CHECK_PHONE"}),
 card({id:"look_away",name:"Look Away",category:"DEADPAN",aura:1,hype:1,stealHype:1,counters:["COOL","CHAOS"],blurb:"Counter. Burn 1 Hype.",script:"LOOK_AWAY"}),
 card({id:"walk_away",name:"Walk Away",category:"DEADPAN",aura:1,hype:0,stealHype:2,counters:["COOL","MEME","CHAOS"],blurb:"Counter. Burn 2 Hype.",script:"WALK_AWAY"}),
 card({id:"absolute_silence",name:"Absolute Silence",category:"DEADPAN",aura:1,hype:1,counters:["MEME","CHAOS"],bonus:{when:"noCounterLastTurn",aura:2},blurb:"+2 if you held your cards.",script:"ABSOLUTE_SILENCE"}),
 ...
 card({id:"do_it_better",name:"Do It Better",category:"MEME",aura:2,hype:1,steal:1,counters:["COOL","CHAOS"],bonus:{when:"mirrorOpponent"},blurb:"Their move, but louder.",script:"DO_IT_BETTER"}),
 card({id:"copy_that",name:"Copy That",category:"MEME",aura:1,hype:1,counters:["COOL","DEADPAN","CHAOS"],bonus:{when:"mirrorOpponent"},blurb:"Mirror the last move.",script:"COPY_THAT"}),
 card({id:"wrong_person",name:"Wrong Person",category:"MEME",aura:2,hype:1,steal:1,counters:["COOL","DEADPAN"],blurb:"Point at nobody. Steal 1.",script:"WRONG_PERSON"}),
 card({id:"npc_reaction",name:"NPC Reaction",category:"MEME",aura:1,hype:1,counters:["COOL","DEADPAN","CHAOS"],bonus:{when:"repeatPunish",aura:2},blurb:"+2 if they repeat a category.",script:"NPC_REACTION"}),
 ...
 card({id:"take_the_throne",name:"Take The Throne",category:"MEME",aura:3,hype:1,steal:2,counters:["FINAL"],finalCounterFor:"the_king_has_arrived",blurb:"Sit down before they do.",script:"TAKE_THE_THRONE"}),
 card({id:"unplug_the_speaker",name:"Unplug The Speaker",category:"DEADPAN",aura:3,hype:1,steal:2,counters:["FINAL"],finalCounterFor:"last_dance",blurb:"Silence the whole moment.",script:"UNPLUG_THE_SPEAKER"}),
